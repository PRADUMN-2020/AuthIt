    ...
    <>
      <div className=' relative  overflow-hidden bg-slate-700'>
          ...
          <div className='relative z-10 pb-8  sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32'>
            <main className='my-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28'>
              <div className='sm:text-center lg:text-left'>
                ...
                <p className='text-justify mt-3 text-base text-slate-400 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-lg lg:mx-0'>
        ...
        <div className='lg:absolute lg:inset-y-10 lg:right-0 lg:w-1/2'>
          <img className='h-56 w-full object-cover sm:h-72 md:h-96 lg:h-96 lg:w-full' src="/block.png" />
        </div> 
      </div>       
    </>
  );
